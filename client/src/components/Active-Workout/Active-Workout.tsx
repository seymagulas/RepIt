...
import {
  ...
  deleteFinishedWorkout,
} from "../../services/finishedWorkout.service";
    ...
    <div>
      <div className="header">
        ...
        {finishedWorkoutId !== null && repeat === false ? (
          <button className="repeat-btn" onClick={handleClickRepeat}>
            RESTART
          </button>
        ) : (
              ...
              {[...Array(exercise.sets)].map((_, setIndex) => (
                <div className="set-row" key={setIndex}>
                  ...
                  <input
                    ...
                    type="number"
                    value={
                      weightData[exerciseIndex * exercise.sets + setIndex] || 0
                    }
                    onChange={(e) =>
                      handleWeightChange(
                  ...
                  <input
                    ...
                    type="number"
                    value={
                      repsData[exerciseIndex * exercise.sets + setIndex] || 0
                    }
                    onChange={(e) =>
                      handleRepsChange(
                        exerciseIndex * exercise.sets + setIndex,
